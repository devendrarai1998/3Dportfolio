...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const serviceId = 'service_fav3rrj';
    const templateId = 'template_59uyzbo';
    const publicKey = 'piLc60wglkoaLm5rT';

    emailjs.send( serviceId, templateId, publicKey,
      {
        from_name: form.name,
        to_name: "Devendra Kumar Rai",
        from_email: form.email,
        to_email: "devendra.rai.1910@gmail.com",
